...
export const translations: TranslationMap = {
  en: {
    ...
    hero_pill2: '100% Certified Wellness Spa (Free Parking)',
    ...
    service2_title: 'Office Syndrome (Neck, Shoulder & Back)',
    service2_badge: '🔥 Most Popular',
    service2_desc: 'Targeted deep-tissue work on neck, shoulders, upper back, and shoulder blades — ideal for long computer work or post-golf muscle tightness.',
  ...
  th: {
    ...
    hero_pill2: 'นวดเพื่อสุขภาพแท้ 100% สบส. รับรอง (มีที่จอดรถสะดวก)',
    ...
    highlight2_desc: 'เทราพีสทุกคนผ่านการฝึกอบรม ขึ้นทะเบียนผู้ให้บริการนวดเพื่อสุขภาพจากกรมสนับสนุนบริการสุขภาพ (สบส.) สบายใจ นวดตรงจุด (ไม่มีบริการนอกสถานที่)',
    ...
    service2_title: 'นวดออฟฟิศซินโดรม (คอ บ่า ไหล่)',
    service2_badge: '🔥 เมนูฮิตแก้อาการ',
    service2_desc: 'เน้นย้ำพิเศษสลายพังผืด คลายน็อตปวด คอ บ่า ไหล่ และสะบักตึง เหมาะสำหรับผู้ที่ทำงานนั่งหน้าคอมนานๆ หรือปวดเมื่อยหลังตีกอล์ฟ',
