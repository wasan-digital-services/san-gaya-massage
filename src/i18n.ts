...
export const translations: TranslationMap = {
  en: {
    ...
    service_btn_call: '📞 Call for Pricing',
    service_btn_line: '💬 Enquire on LINE',
  ...
  th: {
    ...
    service_btn_call: '📞 โทรถามราคา',
    service_btn_line: '💬 สอบถามใน LINE',
  ...
  zh: {
    ...
    service_btn_call: '📞 来电咨询价格',
    service_btn_line: '💬 LINE 在线咨询',
